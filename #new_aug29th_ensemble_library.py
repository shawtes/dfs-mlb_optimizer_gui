...
name_encoder_path = '/Users/sineshawmesfintesfaye/newenv/name_encoder_1.pkl'
team_encoder_path = '/Users/sineshawmesfintesfaye/newenv/team_encoder_1.pkl'
...
scaler_path = '/Users/sineshawmesfintesfaye/newenv/scaler_sep2_1.pkl'
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/Users/sineshawmesfintesfaye/newenv/fangraphs-leaderboards_full_sep1_full_list_batters_traning.csv',
    ...
    k = min(35, n_features)  # Select the minimum of 25 or the actual number of features
    ...
    # Clean infinite values in the dataset
    ...
    pipeline.fit(features, df['calculated_dk_fpts'])
